...
ENV_TP_LINK_ROUTER_EXPORTER_HOST = os.getenv(
    "TP_LINK_ROUTER_EXPORTER_HOST",
    default="0.0.0.0")
...
class base_config(object):
    ...
    SITE_NAME = os.environ.get('APP_NAME', 'TP_LINK_ROUTER_EXPORTER')
    ...
    TP_LINK_ROUTER_EXPORTER_LOGGING_LEVEL = os.environ.get(
        'TP_LINK_ROUTER_EXPORTER_LOGGING_LEVEL',
        logging.INFO)
